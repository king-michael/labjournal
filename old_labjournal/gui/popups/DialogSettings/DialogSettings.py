...
COMPANY_NAME = 'foo'
PATH_TO_DEFAULT_CONFIG = os.path.join(pkg_resources.resource_filename('old_labjournal', ''), "default_conifg.ini")
...
class DialogSettings(QtWidgets.QDialog,Ui_Dialog):
    ...
    def restore_defaults(self):
        ...
        #path_to_config = os.path.join(pkg_resources.resource_filename('old_labjournal', ''), "default_conifg.ini")
