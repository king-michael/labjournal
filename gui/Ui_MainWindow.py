...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_createNew = QtGui.QPushButton(self.frameSide)
        self.pushButton_createNew.setObjectName(_fromUtf8("pushButton_createNew"))
        self.gridLayout_5.addWidget(self.pushButton_createNew, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_createNew.setText(_translate("MainWindow", "Create new Entry", None))
